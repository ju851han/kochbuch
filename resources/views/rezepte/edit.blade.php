...
@section('content')
    ...
    @csrf
        ...
        <input class="form-control"  id="kategorie" name="kategorie" type="text" minlength="2" required value="{{$r->kategorie}}">
       ...
       <label for="Hauptspeise">Hauptspeise</label></br>
        ...
        <input class="form-control"  id="zeit" name="zeit" list="zeiten" type="range" min="15" max="240" step="15"
        ...
        <input class="form-control"  id="kostenjePortion" name="kostenjePortion" type="number" step="0.01" required value="{{$r->kostenjePortion}}">
        <br>
