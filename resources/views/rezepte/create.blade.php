...
@section('content')
    <div class="container">
        ...
        <form method="post" action="/rezepte">
            ...
            <textarea class="form-control" id="zubereitung" name="zubereitung" minlength="20" maxlength="5000" cols="50" rows="5"
            ...
            <input class="form-control" id="kostenjePortion" name="kostenjePortion" type="number" step="0.01" required>
            <span>€</span>
            <br>
