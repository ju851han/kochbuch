...
@section('content')
    ...
    <form method="post" action="/zutaten/{{$z->zName}}/update">
        ...
        <input id="zName" name="zName" type="text" minlength="2" maxlength="256" required value="{{$z->zName}}"><br>
        ...
        <input id="mengeneinheit" name="mengeneinheit" type="text" minlength="1" maxlength="125" required value="{{$z->mengeneinheit}}">
        <br>
        <label for="kostenJeEinheit">Kosten je Einheit</label>
        <input id="kostenJeEinheit" name="kostenJeEinheit" type="text" minlength="1" maxlength="125"  steps="0.01" required value="{{$z->kostenJeEinheit}}">
        <br>
        <label for="produktgruppe">Produktgruppe</label>
        <input id="produktgruppe" name="produktgruppe" type="Text" minlength="2" required value="{{$z->produktgruppe}}">
